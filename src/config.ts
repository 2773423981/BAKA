...
export const siteConfig: SiteConfig = {
	...
	bilibili: {
		vmid: "494620892", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
...
export const commentConfig: CommentConfig = {
	...
	giscus: {
		repo: "2773423981/BAKA",
		repoId: "R_kgDOSCvTlg",
		category: "Blog Comments",
		categoryId: "DIC_kwDOSCvTls4C662w",
		mapping: "pathname",
		strict: "0",
		reactionsEnabled: "1",
		emitMetadata: "0",
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "欢迎来到椛的小站", // 欢迎词
		touch: ["哎嘿嘿～", "再摸给你🐎杀了喵", "BAKA!", "别摸啦喵"], // 触摸提示
		home: "点这个一键返回主页喵", // 首页提示
		skin: ["想看我的新衣服喵?", "这套新衣服看起来很棒喵~"], // 换装提示
